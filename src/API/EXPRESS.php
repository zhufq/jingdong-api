...
trait EXPRESS
{
    ...
    /**
     * 普通 基础 jingdong.ldop.waybill.receive      京东物流接单接口
     * @param $param
     * @return string
     */
    public function ExpressWaybillReceive($param) {
        return $this->call_jd_function('jingdong.ldop.waybill.receive', $param);
    }
     ...
     * @return string
     */
    public function ExpressPickupCancel($param) {
        return $this->call_jd_function('jingdong.ldop.pickup.cancel', $param);
    }
